...
import { useState, FC, ReactNode, ChangeEvent, FormEvent } from "react";
  ...
  const Step1: FC = () => (
    <div className="w-[351px] lg:w-[718px] m-5 lg:mb-10 lg:mt-10 lg:ml-20">
      <p className="w-[282px] lg:w-[451px] font-manrope text-[15px] lg:text-[24px] font-bold">
        Let's get started! Please share a few basic details with us so we can
  ...
  const Step2: FC = () => {
    ...
    return (
      <div className="w-[351px] lg:w-[700px] p-10">
        <h2 className="font-manrope text-[15px] lg:text-[24px] font-bold mb-5">I Need To...</h2>
        <div>
  ...
  const Step3: FC = () => (
    <div className="w-[351px] lg:w-[700px] p-10 font-manrope">
      <p className="w-[282px] lg:w-[378px] font-bold text-[16px] lg:text-[24px] mb-10">
        Almost There!
        Tell Us A Bit About Yourself To Wrap It Up.
      </p>
  ...
  return (
    <div className="relative max-h-[90vh] bg-[#1E1F23] text-white rounded-[18px] overflow-y-auto">
      ...
      <div className="h-[73px] flex items-center justify-end border-t-[1px] border-[#353535]">
        <div
          onClick={onClose}
          className="w-[57px] h-[57px] rounded-[10px] mr-5 bg-[#17171A] flex items-center justify-center"
        >
          <X size={24} />
        </div>
      </div>
